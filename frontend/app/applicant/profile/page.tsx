              ...
              <button
                ...
                className={`inline-flex items-center justify-center gap-2 rounded-xl px-5 py-2.5 text-sm font-semibold transition-colors ${
                  canSave && !updateProfileMutation.isPending
                    ? "bg-[#087F5B] text-white hover:bg-[#066B4D]"
            ...
            <div className="mt-6 grid grid-cols-1 gap-6 md:grid-cols-2">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-gray-200 bg-white py-2.5 pl-10 pr-3 text-sm outline-none focus:border-[#087F5B]"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-gray-200 bg-white py-2.5 pl-3 text-sm outline-none focus:border-[#087F5B]"
                />
              </div>
              ...
              <div>
                ...
                <PhoneInput
                  ...
                  className="w-full rounded-xl border border-gray-200 bg-white py-2.5 px-3 text-sm outline-none focus:border-[#087F5B]"
                />
              </div>
              ...
              <div className="md:col-span-2">
                <div className="rounded-xl border border-gray-100 bg-[#F9FAFB] p-5">
                  ...
                  <p className="text-xs text-[#6B7280] mb-3">
                    Upload a new profile picture. This will be shown across your applicant dashboard.
                  </p>
                  <UploadButton
