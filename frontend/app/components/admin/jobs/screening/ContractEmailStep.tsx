...
const DEFAULT_CONTRACT_EMAIL = {
  subject: "Employment Contract - {{position}} at HireLens",
  body: `Dear {{candidateName}},

Congratulations! We are pleased to offer you the position of {{position}} at HireLens.
...
export default function ContractEmailStep({
  ...
  const generateContractPDF = (candidate: ContractWithEmail) => {
    ...
    doc.text("HireLens Employment Contract", 105, 20, { align: "center" });
    ...
    doc.text(
      "This contract was generated by HireLens HR System",
      105,
      pageHeight - 15,
      { align: "center" },
    );
    doc.text("© 2026 HireLens. All rights reserved.", 105, pageHeight - 10, {
      align: "center",
    });
    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
      ...
      <div className="rounded-xl border border-green-100 bg-[#F8F8FD] p-4">
        <div className="flex items-center justify-between">
          ...
          {!allSent && (
            <button
              ...
              className="inline-flex items-center gap-2 rounded-lg bg-[#087F5B] px-4 py-2 text-sm font-bold text-white hover:bg-[#066B4D] disabled:opacity-50"
            >
              {sendingId ? (
        ...
        <div className="mt-3 h-2 rounded-full bg-gray-200">
          <div
            className="h-2 rounded-full bg-[#087F5B] transition-all"
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {isSent ? (
                        ...
                        <button
                          ...
                          disabled={isSending}
                          className="inline-flex items-center gap-1 rounded-lg bg-[#087F5B] px-3 py-1.5 text-xs font-bold text-white hover:bg-[#066B4D] disabled:opacity-50"
                        >
                          {isSending ? (
